...
if ismac
%   path for macbook
    save_path = '/Users/Paul/Dropbox/Apps/Overleaf/IIT - Thesis V2/Images/Chapter4/';
    addpath('/Users/Paul/Documents/GitHub/tameshiwari/matlab')
elseif isunix
%   path for Linux machine
    save_path = '/home/user/Dropbox/Apps/Overleaf/IIT - Thesis V2/Images/Chapter4/';
...
for i = 1:nj
    plot(time,joint_position.q_lb(i,:),'--','Color',ccycle(i,:),'LineWidth',line_width)
    plot(time,joint_position.q_ub(i,:),'--','Color',ccycle(i,:),'LineWidth',line_width)
end
vline(2,'k:','$t_\iota$')
...
for i = 1:nj
    plot(time,joint_velocity.qdot_lb(i,:),'--','Color',ccycle(i,:),'LineWidth',line_width)
    plot(time,joint_velocity.qdot_ub(i,:),'--','Color',ccycle(i,:),'LineWidth',line_width)
end
vline(2,'k:','$t_\iota$')
...
for i = 1:nj
    stairs(time,joint_effort.tau_lb(i,:),'--','Color',ccycle(i,:),'LineWidth',line_width)
    stairs(time,joint_effort.tau_ub(i,:),'--','Color',ccycle(i,:),'LineWidth',line_width)
end
ylim([-125 125])
