...
def homing(q=None):
    ...
    state_str.name = [
        ...
        'hip_yaw_1', 'hip_pitch_1', 'knee_pitch_1', 'ankle_yaw_1', 
        'hip_yaw_2', 'hip_pitch_2', 'knee_pitch_2', 'ankle_yaw_2', 
        'hip_yaw_3', 'hip_pitch_3', 'knee_pitch_3', 'ankle_yaw_3', 
        'hip_yaw_4', 'hip_pitch_4', 'knee_pitch_4', 'ankle_yaw_4'
        ]
    state_str.name += [
        'j_wheel_1','j_wheel_2','j_wheel_3','j_wheel_4',
        'ankle_pitch_1','ankle_pitch_2','ankle_pitch_3','ankle_pitch_4'
        ]
    if not q:
        state_str.position = [0.0, 0.45, 0.5, 0.03, -0.3, -2.2, 0.0, -0.8, 0.0, 0.5, -0.03, 0.3, -2.2, 0.0, 0.8, 0.0, 0.0, -1.0, -1.0, -0.78, 0.0, 1.0, 1.0, 0.78, 0.0, 1.0, 1.0, -0.78, 0.0, -1.0, -1.0, 0.78]
