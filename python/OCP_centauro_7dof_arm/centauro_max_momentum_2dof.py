...
jacEE_string = kindyn.jacobian('arm2_8')
...
pose = fn.RobotPose(name=['j_arm2_1','j_arm2_4'],q=q_opt,qdot=qdot_opt,qddot=qddot_opt,tau=tau_opt,rate=int(1/h_opt[0]))
